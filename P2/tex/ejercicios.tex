...
\end{equation}
 ...
 $$\int_b^a - (x_{n/2}-x+x_{n/2}-x_0) ...(x_{n/2}-x+x_{n/2}-x_{n/2+i-1}) (x_{n/2}-x+x_{n/2}-x_{n/2+i+1})...$$
 $$...(x_{n/2}-x+x_{n/2}-x_n) = $$
 Ahora, por estar los puntos uniformemente distribuidos, sabemos que:
 $$ x_{n/2} - x_{n-i} = x_{0+i} - x_{n/2}$$
 Por tanto, aplicándolo sobre nuestra integral:
 $$\int_b^a - (x_{n/2}-x+x_n-x_{n/2}) ...(x_{n/2}-x+x_{n/2-i+1}-x_{n/2}) (x_{n/2}-x+x_{n/2-1-1}-x_{n/2})...$$
 $$...(x_{n/2}-x+x_0-x_{n/2}) = $$
